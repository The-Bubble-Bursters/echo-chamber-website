...
function LandingPage() {
  return (
    <div>
      ...
      <iframe width="560" height="315" style={{maxWidth: '100%', alignItems: 'center', justifyContent: 'center', textAlign: 'left', margin: '0 auto'}} src="https://www.youtube.com/embed/thQDkvOUY4E?si=9ixZxYLcmeo7BQRO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
